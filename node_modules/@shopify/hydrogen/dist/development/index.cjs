...
// src/cart/queries/cartGiftCardCodesAddDefault.ts
function cartGiftCardCodesAddDefault(options) {
  return async (giftCardCodes, optionalParams) => {
    const { cartGiftCardCodesAdd, errors: errors2 } = await options.storefront.mutate(CART_GIFT_CARD_CODES_ADD_MUTATION(options.cartFragment), {
      variables: {
        cartId: options.getCartId(),
        giftCardCodes,
        ...optionalParams
...
// src/cart/queries/cartDeliveryAddressesReplaceDefault.tsx
function cartDeliveryAddressesReplaceDefault(options) {
  return async (addresses, optionalParams) => {
    const { cartDeliveryAddressesReplace, errors: errors2 } = await options.storefront.mutate(CART_DELIVERY_ADDRESSES_REPLACE_MUTATION(options.cartFragment), {
      variables: {
        cartId: options.getCartId(),
        addresses,
        ...optionalParams
...
var storefrontContext = reactRouter.createContext();
var cartContext = reactRouter.createContext();
var customerAccountContext = reactRouter.createContext();
var envContext = reactRouter.createContext();
var sessionContext = reactRouter.createContext();
var waitUntilContext = reactRouter.createContext();
var hydrogenContext = {
...
function createHydrogenContext(options, additionalContext) {
  ...
  const routerProvider = new reactRouter.RouterContextProvider();
...
function usePagination(connection, namespace = "") {
  ...
  const nodes = react.useMemo(() => {
    ...
    if (isPrevious) {
      return [
        ...hydrogenReact.flattenConnection(connection),
...
Object.defineProperty(exports, "decodeEncodedVariant", {
  enumerable: true,
  get: function () { return hydrogenReact.decodeEncodedVariant; }
});
Object.defineProperty(exports, "flattenConnection", {
  enumerable: true,
  get: function () { return hydrogenReact.flattenConnection; }
});
Object.defineProperty(exports, "getAdjacentAndFirstAvailableVariants", {
  enumerable: true,
  get: function () { return hydrogenReact.getAdjacentAndFirstAvailableVariants; }
});
Object.defineProperty(exports, "getClientBrowserParameters", {
  enumerable: true,
  get: function () { return hydrogenReact.getClientBrowserParameters; }
});
Object.defineProperty(exports, "getProductOptions", {
  enumerable: true,
  get: function () { return hydrogenReact.getProductOptions; }
});
...
Object.defineProperty(exports, "mapSelectedProductOptionToObject", {
  enumerable: true,
  get: function () { return hydrogenReact.mapSelectedProductOptionToObject; }
});
...
Object.defineProperty(exports, "useSelectedOptionInUrlParam", {
  enumerable: true,
  get: function () { return hydrogenReact.useSelectedOptionInUrlParam; }
});
...
exports.cartGiftCardCodesAddDefault = cartGiftCardCodesAddDefault;
exports.cartGiftCardCodesRemoveDefault = cartGiftCardCodesRemoveDefault;
...
exports.getSitemapIndex = getSitemapIndex;
exports.graphiqlLoader = graphiqlLoader;
exports.hydrogenContext = hydrogenContext;
exports.hydrogenPreset = hydrogenPreset;
exports.hydrogenRoutes = hydrogenRoutes;
